...
@interface jtsyzaViewController ()<setcityDelegate>
{
    UIView *yincahngview;
    UIView *footvoew;
    UIView *topview;
...
@implementation jtsyzaViewController
...
-(void)InitControl{
    ...
    topview = [[UIView alloc] initWithFrame:CGRectMake(0,10, viewW, 160)];
    [topview setBackgroundColor:[UIColor whiteColor]];
    [self.view addSubview:topview];
    
    NSArray *titleArray = @[@"姓名",@"性别",@"年龄",@"所求事项"];
    ...
    UIView  *clickview = [[UIView alloc] initWithFrame:CGRectMake(0,180, viewW,40)];
    ...
    int k = 10;
    footvoew = [[UIView alloc] initWithFrame:CGRectMake(0, 230, viewW, 120)];
...
-(void)showviews:(UIButton *)btn
{
    if (yincahngview.hidden) {
        ...
        [footvoew setFrame:CGRectMake(0, 420, viewW, 100)];
    }
    else
    {
        [yincahngview setHidden:YES];
        [checkView setHidden:YES];
        [footvoew setFrame:CGRectMake(0, 2120, viewW, 100)];
    }
}
-(bool)checknil
{
    UITextField *uitext1 = (UITextField *)[self.view viewWithTag:1000];
    UITextField *uiage = (UITextField *)[self.view viewWithTag:1002];
    UITextField *uitsq = (UITextField *)[self.view viewWithTag:1003];
    UITextField *uitext2 = (UITextField *)[self.view viewWithTag:100000];
    UITextField *uitext3 = (UITextField *)[self.view viewWithTag:100002];
    ...
    if (uiage.text.length<1) {
        HUD.mode = MBProgressHUDModeText;
        [HUD setLabelText:@"请填写年龄"];
        [HUD show:YES];
        [HUD hide:YES afterDelay:2];
        return false;
    }
    if (uitsq.text.length<1) {
        HUD.mode = MBProgressHUDModeText;
        [HUD setLabelText:@"请填写所求事项"];
        [HUD show:YES];
        [HUD hide:YES afterDelay:2];
        return false;
    }
...
-(void)btnp{
    ...
    UITextField *Usq = (UITextField *)[self.view viewWithTag:1003];
    ...
    NSString *string = [NSString stringWithFormat:@"%@%@",ServiceAddress,@"cgy/appRemoteServ/saveJthm.do"];
    ...
    [request setPostValue:sq forKey:@"sqsx"];
