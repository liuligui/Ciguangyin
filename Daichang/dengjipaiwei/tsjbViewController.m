...
@interface tsjbViewController ()<setcityDelegate>
{
    UIView *yincahngview;
    UIView *footvoew;
    UIView *topview;
...
@implementation tsjbViewController
...
-(void)InitControl{
    ...
    NSArray *titleArray = @[@"患者姓名",@"患者地址",@"填写人姓名"];
...
-(void) labelTouchUpInside:(UITapGestureRecognizer *)recognizer{
    ...
    if([label.text isEqualToString:@"请填写病人地址"])
    {
        sw = @"sw";
    }
    else
...
-(void)btnp{
    ...
    [request setPostValue:name forKey:@"hz_name"];
    [request setPostValue:lbaddress.text forKey:@"hz_address"];
    [request setPostValue:namey forKey:@"ts_tbr"];
