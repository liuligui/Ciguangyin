...
@interface tshyzViewController ()<setcityDelegate>
{
    UIView *yincahngview;
    UIView *footvoew;
    UIView *topview;
...
@implementation tshyzViewController
- (void)viewDidLoad {
    self.title =_vctitle;
    [super viewDidLoad];
...
-(void)InitControl{
    ...
    NSArray *titleArray = @[@"阳上人姓名",@"营业地址",@"阳上人姓名"];
...
-(void)btnp{
    ...
    NSString *string = [NSString stringWithFormat:@"%@%@",ServiceAddress,@"cgy/appRemoteServ/saveTsjb.do"];
