...
@interface fzcswzlpwViewController ()<setcityDelegate>
{
    UIView *yincahngview;
    UIView *footvoew;
    UIView *topview;
...
@implementation fzcswzlpwViewController
...
-(void)InitControl{
    ...
    NSArray *titleArray = @[@"亡者姓名",@"亡者地址",@"填写人姓名"];
...
-(void) labelTouchUpInside:(UITapGestureRecognizer *)recognizer{
    ...
    if([label.text isEqualToString:@"请填写亡者地址"])
    {
        sw = @"sw";
    }
    else
...
-(void)btnp{
    ...
    NSString *string = [NSString stringWithFormat:@"%@%@",ServiceAddress,@"cgy/appRemoteServ/saveFzcsw.do"];
    ...
    [request setPostValue:lbwaddress.text forKey:@"die_address"];
